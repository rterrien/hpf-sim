...
;;	ws = ws1
	...
	;y_size_kernel = floor((nfibers + 1.) * kernel_sep_pix)
	y_size_kernel = floor(nfibers * (kernel_sep_pix + kernel_size_pix) + kernel_sep_pix)
