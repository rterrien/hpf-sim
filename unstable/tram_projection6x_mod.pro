...
;;		
		...
		for j=0, nfibers-1 do begin
			...
			tk = psf_gaussian(npixel=[x_size_kernel,y_size_kernel],fwhm=[kernel_size_pix*upfactor,kernel_size_pix*1d],centroid=[x_center_kernel,ycenter],/double,/normalize)/double(nfibers)
